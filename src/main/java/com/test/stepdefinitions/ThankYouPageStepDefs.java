...
public class ThankYouPageStepDefs {
    ...
    public void iVerifyAllTheLineItemsInTheCartOnThankYouPage() {
        ...
        $(By.xpath("//*[contains(text(),'Estimated Sales Tax for ')]")).should(visible, Duration.ofSeconds(20));        conciergeCartPageScreen.getTotalMemberPrice().shouldHave(text("$2,156.00"), Duration.ofMinutes(1));
