...
public class ConciergeUserAccountPage {
    ...
    private final SelenideElement cartButton = $(By.xpath("(//h6[@class='MuiTypography-root MuiTypography-subtitle1'])[2]"));
    ...
    private final SelenideElement clientButton = $(By.xpath("(//h6[@class='MuiTypography-root MuiTypography-subtitle1 MuiTypography-displayInline'])[3]"));
