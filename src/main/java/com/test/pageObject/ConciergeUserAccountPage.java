...
public class ConciergeUserAccountPage {
  ...
  private final SelenideElement clientButton = $(By.xpath("//div[1]/div[@class='MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-align-items-xs-center']/h6"));
  ...
  private final SelenideElement clientLookupHeaderBtn = $(By.xpath("//li[@id='1']"));
