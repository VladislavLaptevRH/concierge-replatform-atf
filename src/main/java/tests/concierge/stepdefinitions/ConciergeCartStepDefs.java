...
public class ConciergeCartStepDefs {
    ...
    public void iClickOnViewCartButton() {
        ...
        with().pollInterval(5, SECONDS).await().until(() -> true);
        conciergeItemsScreen.getViewCartButton().shouldHave(text("View Cart"), Duration.ofSeconds(12));
        conciergeItemsScreen.getViewCartButton().should(interactable, Duration.ofSeconds(12));
        conciergeItemsScreen.getViewCartButton().click(ClickOptions.usingJavaScript());
    }
