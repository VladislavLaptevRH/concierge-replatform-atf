...
public class PdpScreen {
    ...
    private final SelenideElement configureDeliveryInformationSPO = $(By.xpath("//*[contains(text(), 'This item is special order and will be ready for delivery between')]"));
