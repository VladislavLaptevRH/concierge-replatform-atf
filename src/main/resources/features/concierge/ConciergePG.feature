...
Feature: Concierge PG Page
  ...
  Scenario: Verify that PG is defaulted to 3-grid view
    ...
    Then I verify that 'Grid View in PG is set to 3-grid view by default'
  ...
  Scenario: Verify that Sale Price is present in Sale PGs
    ...
    Then I click 'sale checkbox'
    Then I verify that 'Verify that all products have text From $ / $ Sale / $ Member'
