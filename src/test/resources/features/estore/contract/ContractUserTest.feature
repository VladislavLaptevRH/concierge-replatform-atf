...
Feature:
    As a contract user
    I want to be able to login to the site. Also,I want to be able to add different types of product to cart. I verify the contract price should be display on PDP and cart page.


Scenario: Contract User Sign In
    Given I open the "Contract" Sign In page
    When I enter "Contract" credentials for "stagingUser"
    Then I expect that I am successfully signed in as "Contract" user


Scenario Outline: Contract user can add item to cart
    ...
    Then I verify the "Contract" price is displayed on "PDP" page
...
Scenario: Contract User Logout
    Given I open the "Contract" Sign In page
    When I click on Sign out Of my "Contract" Id
    Then I expect that I am not signed in as "Contract" user                  