...
Scenario Outline: Trade user successfully placing an order
        ...
        Then I verify the "Trade" price is displayed on "Order-Review" page
        When I click on Place Order
        Then I land on Thank you page and I see the Order Number
        Then I verify the "Trade" price is displayed on "Thank-You" page
         Examples:
            | cardType        | cardNumber       | expMonth | expYear | ccv  |
